...
const Navigation = () => {
  return (
    <nav className='flex items-center justify-between py-6 px-16 gap-30'>
      <div className='flex items-center gap-6'>
        {/* Logo */}
        <a className='text-2xl text-black font-bold gap-8' href='/'>E-SHOP</a>
      </div>
      ...
      <div className='flex justify-center'>
        {/* Search Bar */}
        <div className='border border-gray-300 rounded flex overflow-hidden'>
      ...
      <div className='flex flex-wrap items-center gap-4'>
        ...
        <ul className="flex gap-8">
          <li><button className='cursor-pointer'><WishListIcon/></button></li>
          <li><Link to="/cart-items"><CartIcon/></Link></li>
          <li><button className='cursor-pointer'><AccountIcon/></button></li>
        </ul>
      </div>
    </nav>
  )
